...
export function AppSidebar({ activeModule, setActiveModule }: AppSidebarProps) {
  ...
  return (
    <Sidebar className="border-r bg-white dark:bg-gray-900 shadow-lg" collapsible="icon">
                  ...
                  <SidebarMenuButton
                    ...
                    className={`w-full justify-start px-3 py-2 rounded-lg transition-all duration-200 ${
                      activeModule === item.id
                        ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 border-l-4 border-yellow-600 dark:border-yellow-400"
          ...
          {isCollapsed ? (
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-center">
                <div className="text-sm font-semibold text-gray-800 dark:text-gray-200">Zolka</div>
