  ...
  return <Sidebar className="border-r bg-white dark:bg-gray-900 shadow-lg" collapsible="icon">
      ...
      <SidebarFooter className="p-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-center">
          {isCollapsed ? <img src="/lovable-uploads/c41c9428-bce8-4d15-bc92-f2bf789c5576.png" alt="Zolka Logo" className="w-8 h-8 object-contain" /> : <div className="flex items-center space-x-2">
              <img src="/lovable-uploads/c41c9428-bce8-4d15-bc92-f2bf789c5576.png" alt="Zolka Logo" className="w-8 h-8 object-contain" />
